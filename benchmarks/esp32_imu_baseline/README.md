...
git fetch origin
git switch benchmark/esp32-imu-fused-a1-b1
git pull --ff-only origin benchmark/esp32-imu-fused-a1-b1
...
```powershell
python .\scripts\summarize_results.py .\esp32-imu-fusion.log `
