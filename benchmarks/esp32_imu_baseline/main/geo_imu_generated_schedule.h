 ...
 */
#ifndef GEO_GENERATED_IMU_ORIENTATION_SPARSE_V1_H
#define GEO_GENERATED_IMU_ORIENTATION_SPARSE_V1_H

#include <stdint.h>

static inline void geo_generated_float_gravity(
    float qw,
    float qx,
    float qy,
    float qz,
...
static inline void geo_generated_q32_gravity(
    int32_t qw,
    int32_t qx,
    int32_t qy,
    int32_t qz,
...
static inline void geo_generated_float_q_times_vector_quaternion(
    float qw,
    float qx,
    float qy,
    float qz,
...
static inline void geo_generated_q32_q_times_vector_quaternion(
    int32_t qw,
    int32_t qx,
    int32_t qy,
    int32_t qz,
...
#endif /* GEO_GENERATED_IMU_ORIENTATION_SPARSE_V1_H */
